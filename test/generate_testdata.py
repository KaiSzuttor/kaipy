...
h5_dh = h5py.File('test.h5', 'w')

# h5 groups
p_group = h5_dh.create_group("/particles/atoms/position")
id_group = h5_dh.create_group("/particles/atoms/id")
im_group = h5_dh.create_group("/particles/atoms/image")
box_group = h5_dh.create_group("particles/atoms/box")
